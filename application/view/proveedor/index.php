...
<div class="container">
        ...
        <a target="blank" href="<?php echo URL; ?>proveedor/reportes" class="btn btn-secondary  mb-2">Reporte general</a>
        <table class="table table-striped border tablas">
            ...
            <?php foreach ($proveedores as $proveedor) { ?>
                <tr>                
                    ...
                    <td><a target="blank" href="<?php echo URL . 'proveedor/reportei/' . htmlspecialchars($proveedor->IDProveedor, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-secondary  ">Reporte</a></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>        
