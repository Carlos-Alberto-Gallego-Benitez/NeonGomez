...
<div class="container">
        ...
        <a target="blank" href="<?php echo URL; ?>usuario/reportes" class="btn btn-secondary  ml-2 mb-2">Reporte general</a>
        <table class="table table-striped border tablas">
            ...
            <?php foreach ($usuarios as $usuario) { ?>
                <tr>                
                    ...
                    <td><a target="blank" href="<?php echo URL . 'usuario/reporteUnitario/' . htmlspecialchars($usuario->IDUsuario, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-secondary  mx-md-n1">Reporte</a></td>
