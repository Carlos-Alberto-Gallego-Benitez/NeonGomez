...
<div class="container">
        ...
        <a target="_blank" href="<?php echo URL; ?>usuario/reportes" class="btn btn-secondary  ml-2 mb-2">Reporte general</a>
        <table class="table table-striped border tablas">
            ...
            <?php foreach ($usuarios as $usuario) { ?>
                <tr>                
                    ...
                    <td><a target="_blank" href="<?php echo URL . 'usuario/reporteUnitario/' . htmlspecialchars($usuario->IDUsuario, ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-secondary  ml-1">Reporte</a></td>
