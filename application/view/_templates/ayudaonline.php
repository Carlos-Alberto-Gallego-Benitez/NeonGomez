...
<body class="bg-black">
  ...
  <h2 class="text-center mb-5">¿Cuál es su duda?</h2>
  ...
  <div class="col-xl-6 col-md-6">
      ...
      <div class="card bg-light text-dark mb-3">
          ...
          <div>
            <iframe width="538" height="300" src="https://www.youtube.com/embed/Gsq0DVHWGN4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>          </div>
        </div>
      </a>
  </div>
