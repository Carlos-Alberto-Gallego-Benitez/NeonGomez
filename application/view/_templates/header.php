                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                     ...
                     <?php if ($insumos!= null) {?>
                       ...
                       <?php foreach($insumos  as $insumo){?>
                        ...
                        <font  color="Teal"><h6 class="text-center"> !Ojo¡, las unidades se escasean abastecete <font color="Red"> <h4>:(</h4></font></h6></font>
